...
void DrawInventoryOnHUD( CBlob@ this, Vec2f tl, Vec2f hudPos = Vec2f(0,0) )
{
	...
	for (int i = 0; i < inv.getItemsCount(); i++)
	{
		...
		else if (itemname == "Grain") { GUI::DrawIcon(jitem, 18, jdim, itempos, 1.0f ); }
		else if (itemname == "Bushy Seed") { GUI::DrawIcon(jitem, 20, jdim, itempos, 1.0f ); }
		else if (itemname == "Pine Seed") { GUI::DrawIcon(jitem, 21, jdim, itempos, 1.0f ); }
		else if (itemname == "Oak Seed") { GUI::DrawIcon(jitem, 22, jdim, itempos, 1.0f ); }
		...
		else if (itemname == "Soul Shard") { GUI::DrawIcon(jitem, 29, jdim, itempos, 1.0f ); }
