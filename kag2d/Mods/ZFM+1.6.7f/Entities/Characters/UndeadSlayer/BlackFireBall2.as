...
{
return (this.getTeamNum() != blob.getTeamNum() && blob.hasTag("flesh")) || blob.hasTag("survivorbuilding") || blob.hasTag("dead") || blob.hasTag("ally") || blob.hasTag("survivormechanism") || blob.hasTag("blocks water");
}
