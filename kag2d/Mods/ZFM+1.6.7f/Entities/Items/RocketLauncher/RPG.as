...
{
    return (this.getTeamNum() != blob.getTeamNum() && blob.hasTag("flesh")) || blob.hasTag("ZP") || blob.hasTag("dead") || blob.hasTag("enemy") || blob.hasTag("survivormechanism") || blob.hasTag("blocks water");
